...
def dynamic_select_benchmark(num : int, dest: str | Path, dirs: str | Path, percentiles : float, distr : str, duration: float, progress_bar=None):
    ...
    for i in range(num):
        ...
        for j in range(len(dirs)):
            ...
            logging.info(f"Segment {j+1} coefficient: {sc}")
